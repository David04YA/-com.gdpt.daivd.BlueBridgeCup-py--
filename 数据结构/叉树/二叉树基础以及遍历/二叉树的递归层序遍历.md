...
- [二叉树基本概念和几种特殊的二叉树](https://labuladong.online/algo/data-structure-basic/binary-tree-basic/)
...
![image-20251030132137740](C:\Users\26705\AppData\Roaming\Typora\typora-user-images\image-20251030132137740.png)

了解了 [二叉树基本概念和几种特殊的二叉树](https://labuladong.online/algo/data-structure-basic/binary-tree-basic/)，本文来讲解如何遍历和访问二叉树的节点。
...
## [递归遍历（DFS）](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#递归遍历-dfs)
...
https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#div_binary-tree-traverse-example
...
### [理解前/中/后序遍历](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#理解前-中-后序遍历)
...
[前序遍历](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#div_btree-preorder-example)

[中序遍历](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#div_btree-inorder-example)

[后序遍历](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#div_btree-inorder-example)
...
我会在 [二叉树算法思想（纲领篇）](https://labuladong.online/algo/essential-technique/binary-tree-summary/) 和习题中深入探讨二叉树遍历框架的前中后序位置，以及如何运用到回溯算法、动态规划算法中，这里就不展开了。
...
最后一个知识点，[二叉搜索树（BST）](https://labuladong.online/algo/data-structure-basic/binary-tree-basic/) 的中序遍历结果是有序的，这是 BST 的一个重要性质。

可以看这个可视化面板，点击代码，就可以看到中序遍历访问节点的顺序：

[BST的中序遍历结果是有序的](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#div_bst-inorder-example)

在后面的 [BST 相关习题集](https://labuladong.online/algo/problem-set/bst1/) 中，会有一些题目利用到这个特性。

## [层序遍历（BFS）](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#层序遍历-bfs)

上面讲的递归遍历是依赖函数堆栈递归遍历二叉树的，遍历顺序是从最左侧开始，一列一列地走到最右侧。

二叉树的层序遍历，顾名思义，就是一层一层地遍历二叉树：

![1](C:\Users\26705\Desktop\IDE\TsingPig蓝桥杯py速成\数据结构\二叉树\二叉树基础以及遍历\1.jpeg)

层序遍历需要借助队列来实现，而且根据不同的需求，可以有三种不同的写法，下面一一列举。

### [写法一](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#写法一)
...
### [写法二](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#写法二)
...
你可以打开这个可视化面板，点击其中的 `console.log`，观察 `cur` 变量在树上游走的顺序，就可以看到还是一层一层，从左到右的遍历二叉树节点，但是这次还会输出节点所在的层数：

[二叉树的层序遍历2](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#div_basic-levelorder2)

这种写法就可以记录下来每个节点所在的层数，可以解决诸如二叉树最小深度这样的问题，是我们最常用的层序遍历写法。

### [写法三](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#写法三)
...
class State:
    def __init__(self, node, depth):
        self.node = node #一个二叉树的节点
        self.depth = depth #节点对应的深度	
...
## [其他遍历？](https://labuladong.online/algo/data-structure-basic/binary-tree-traverse-basic/#其他遍历)
