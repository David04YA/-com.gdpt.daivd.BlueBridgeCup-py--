...
- [几种常见的二叉树](https://labuladong.online/algo/data-structure-basic/binary-tree-basic/#几种常见的二叉树)
- - [满二叉树](https://labuladong.online/algo/data-structure-basic/binary-tree-basic/#满二叉树)
  - [完全二叉树](https://labuladong.online/algo/data-structure-basic/binary-tree-basic/#完全二叉树)
  - [二叉搜索树](https://labuladong.online/algo/data-structure-basic/binary-tree-basic/#二叉搜索树)
  - [高度平衡二叉树](https://labuladong.online/algo/data-structure-basic/binary-tree-basic/#高度平衡二叉树)
  - [自平衡二叉树](https://labuladong.online/algo/data-structure-basic/binary-tree-basic/#自平衡二叉树)
- [二叉树的实现方式](https://labuladong.online/algo/data-structure-basic/binary-tree-basic/#二叉树的实现方式)
...
![image-20251028203641009](C:\Users\26705\AppData\Roaming\Typora\typora-user-images\image-20251028203641009.png)
...
直接看图比较直观，满二叉树就是每一层节点都是满的，整棵树像一个正三角形：![image-20251029141132995](C:\Users\26705\AppData\Roaming\Typora\typora-user-images\image-20251029141132995.png)
...
![image-20251029141207508](C:\Users\26705\AppData\Roaming\Typora\typora-user-images\image-20251029141207508.png)
...
![1](C:\Users\26705\Desktop\IDE\TsingPig蓝桥杯py速成\数据结构\二叉树\二叉树基础以及遍历\1.jpg)
...
![trees](C:\Users\26705\Desktop\IDE\TsingPig蓝桥杯py速成\数据结构\二叉树\二叉树基础以及遍历\trees.png)
...
![image-20251029142526638](C:\Users\26705\AppData\Roaming\Typora\typora-user-images\image-20251029142526638.png)

节点 `7` 的左子树所有节点的值都小于 `7`，右子树所有节点的值都大于 `7`；节点 `4` 的左子树所有节点的值都小于 `4`，右子树所有节点的值都大于 `4`，以此类推。

相反的，下面这棵树就不是 BST：

![image-20251029142539459](C:\Users\26705\AppData\Roaming\Typora\typora-user-images\image-20251029142539459.png)
...
![image-20251029143227786](C:\Users\26705\AppData\Roaming\Typora\typora-user-images\image-20251029143227786.png)

下面这棵树就不是高度平衡的二叉树，因为节点 `2` 的左子树高度是 2，右子树高度是 0，高度差超过 1，不符合条件：

![image-20251029173354854](C:\Users\26705\AppData\Roaming\Typora\typora-user-images\image-20251029173354854.png)

> 以节点2为例子：
>
> 左子树2-4-8 高度为2
>
> 右子树 节点2不存在右子树 Null 高度为0 2!=0则高度不平衡

**假设高度平衡二叉树中共有 N\*N\* 个节点，那么高度平衡二叉树的高度是 O(log⁡N)\*O\*(log\*N\*)**。这是非常重要的性质，本站后面的章节会讲解几种基于二叉树的数据结构，如果能保证树的高度为 O(log⁡N)*O*(log*N*)，那么这些数据结构的增删查改效率就会很高。

反之，如果树很不平衡，比如这种极端情况：

![image-20251029211723144](C:\Users\26705\AppData\Roaming\Typora\typora-user-images\image-20251029211723144.png)
...
![image-20251030073757949](C:\Users\26705\AppData\Roaming\Typora\typora-user-images\image-20251030073757949.png)
